...
class CurrencyController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('FreelancerToolsPaymentBundle:Currency')->findAll();
     ...
     * @Method("POST")
     * @Template("FreelancerToolsPaymentBundle:Currency:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('FreelancerToolsPaymentBundle:Currency')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("FreelancerToolsPaymentBundle:Currency:edit.html.twig")
     */
